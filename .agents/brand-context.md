...
This file is a concise derivative of `REQUIREMENTS.md` and `PRODUCT.md`, not a second behavior contract. If wording conflicts, authority flows from `REQUIREMENTS.md` → `PRODUCT.md` → this file → README and assets.
...
- **Personality Words**: clear, restrained, honest, evidence-minded, correctable
- **Tone**: calm and direct; experienced without authority theater; serious without report-like stiffness
- **Voice Principle**: Receive the user's situation first, state uncertainty and evidence limits plainly, make one useful recommendation, and preserve the user's control

## Values & Mission

- **Core Values**: user autonomy, evidence honesty, minimal necessary escalation, reversibility, accessibility
- **Mission**: Help people confirm what they are really deciding before AI, they, or their team commit important resources—and let real results revise the judgment afterward.
